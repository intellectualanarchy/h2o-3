...
public class AstSum extends AstPrimitive {
  @Override
  public String[] args() {
  ...
  /**
   * Compute Frame sums by rows, and return a frame consisting of a single Vec of sums in each row.
   */
  ...
  /**
   * Compute column-wise sums (i.e. sums of each column), and return a frame having a single row.
   */
